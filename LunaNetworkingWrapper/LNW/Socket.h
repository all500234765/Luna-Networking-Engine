...
namespace LNW {
    namespace MessageHandle {
        ...
        struct _MessageHandler {
            ...
            bool Wmsg() const { return WelcomeMsgHandle != nullptr; }
            bool Cmsg() const { return ClientMsgHandle  != nullptr; }
            bool Smsg() const { return ServerMsgHandle  != nullptr; }
        };
    };
    ...
    private:
        ...
        MessageHandle::_MessageHandler* MessageHandler;
    public:
        Socket(): Sock(INVALID_SOCKET), isTCP(false), isValid(false) {};
        Socket(bool tcp=true, MessageHandle::_MessageHandler* msg=new MessageHandle::_MessageHandler());
